...
from helpers import Timings, load_config_yaml, save_from_urls
...
async def run_client():
    ...
    # Register the 'exact' scheme for Base Mainnet and Sepolia
    ...
    async with httpx.AsyncClient() as http_client:
        # 1. Request without payment (pricing)
        ...
        # Parse the 402 response using x402 library
